...
'*****************************************************************
'       Add by Flumen  Apr 2025
'*****************************************************************

Public Function exe_path() As String
...
Public Sub KeyBind()
    ...
    With KeyBindings
        .Add KeyCode:=BuildKeyCode(wdKeyL, wdKeyAlt), _
            KeyCategory:=wdKeyCategoryCommand, _
            Command:="LaTeXEntry"
        .Add KeyCode:=BuildKeyCode(wdKeyN, wdKeyAlt), _
            KeyCategory:=wdKeyCategoryCommand, _
            Command:="EqnNumber"
        .Add KeyCode:=BuildKeyCode(wdKeyS, wdKeyAlt), _
            KeyCategory:=wdKeyCategoryCommand, _
            Command:="Setting"
    End With
